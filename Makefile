...
shell: header.h main.c process_info.h process_info.c prompt.c UI.c parser.c user_exit.c directories.c inbuilt.c history.c signal_handler.c pipe_redirect.c env.c jobs.c
	gcc -o z header.h main.c process_info.h process_info.c prompt.c UI.c parser.c user_exit.c directories.c inbuilt.c history.c signal_handler.c pipe_redirect.c env.c jobs.c -Wall
